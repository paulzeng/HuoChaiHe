 ...
 * @author liuhai
 * @version $Rev$
 * @time 2016/3/15 14:34
 * @des ${TODO}
 * @updateAuthor $Author$
 * @updateDate 2016/3/15$
 * @updateDes ${TODO}
 */
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void initView(Context context) {
        ...
        mLeftText.setTextColor(getResources().getColorStateList(R.color.title_common));
        ...
        mCenterText.setTextColor(getResources().getColorStateList(R.color.title_common));
     ...
     *
     * @param actionList the actions to setList
     */
     ...
     *
     * @param action the action to setList
     */
     ...
     *
     * @param action the action to setList
     * @param index  the position at which to setList the action
     */
    ...
    private View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            if (mActionTextColor != 0) {
                ...
                text.setTextColor(getResources().getColorStateList(R.color.white));
            }
            view = text;
        }
    ...
    public void setTitle(int leftId, String leftText, String centerText, int rightId, String rightText,
                         final OnClickListener leftOnclick, final OnClickListener rightOnclick) {
        //this.setImmersive(true);

        if ((Integer) leftId != null) {
            this.setLeftImageResource(leftId);
        }
        if (!TextUtils.isEmpty(leftText)) {
            this.setLeftText(leftText);
        }
        if (!TextUtils.isEmpty(centerText)) {
            this.setTitle(centerText);
        }
        if (leftOnclick != null) {
            mLeftText.setOnClickListener(leftOnclick);
        }

        if (!TextUtils.isEmpty(rightText)) {
            TextView rightTextView = (TextView) this.addAction(new TitleBar.TextAction(rightText) {
                @Override
                public void performAction(View view) {

                }
            });
            rightTextView.setTextColor(getResources().getColorStateList(R.color.white));
            if ((Integer) rightId != null) {
                rightTextView.setCompoundDrawablesWithIntrinsicBounds(rightId, 0, 0, 0);
            }
            if (rightOnclick != null) {
                rightTextView.setOnClickListener(rightOnclick);
            }
        } else {
            if ((Integer) rightId != null) {
                ImageView iv = (ImageView) this.addAction(new TitleBar.ImageAction(rightId) {
                    @Override
                    public void performAction(View view) {
                    }
                });
                if (rightOnclick != null) {
                    iv.setOnClickListener(rightOnclick);
                }
            }
